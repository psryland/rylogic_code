...
def RegenerateAll(root, showMaxID):
	f = Face.Face()
	f.ReadFromFile(os.path.abspath(root + "include/scintilla/Scintilla.iface"))
	Regenerate(os.path.abspath(root + "../../include/scintilla/Scintilla.h"), "/* ", printHFile(f))
	Regenerate(os.path.abspath(root + "../../include/scintilla/SciLexer.h"), "/* ", printLexHFile(f))
	if showMaxID:
