...
try:
	...
	projdir   = sys.argv[1] if len(sys.argv) > 1 else UserVars.root + "\\projects\\LDraw\\"
	targetdir = sys.argv[2] if len(sys.argv) > 2 else UserVars.root + "\\projects\\LDraw\\bin\\Debug\\"
