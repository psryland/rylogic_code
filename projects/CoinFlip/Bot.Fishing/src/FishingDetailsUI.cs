...
namespace Bot.Fishing
{
	public class FishingDetailsUI :UserControl, IDockable
	{
		...
		public FishingDetailsUI(Fisher fisher)
		{
			InitializeComponent();
			Fisher = fisher;
		...
		private void UpdateUI(object sender = null, EventArgs args = null)
		{
			#region B2Q
			{
				...
				else
				{
					...
					m_tb_b2q_status.BackColor      = Color_.FromArgb(Fisher.FishingTrade.EResult.Unknown.Assoc<uint>("Color"));
				}
			}
			#endregion
			#region Q2B
			{
				...
				else
				{
					...
					m_tb_q2b_status.BackColor      = Color_.FromArgb(Fisher.FishingTrade.EResult.Unknown.Assoc<uint>("Color"));
				}
			}
			#endregion
