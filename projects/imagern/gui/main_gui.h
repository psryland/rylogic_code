...
//********************************
#pragma once
#ifndef IMAGERN_MAIN_GUI_H
#define IMAGERN_MAIN_GUI_H

#include "imagern/main/forward.h"
#include "imagern/res/imagern.resources.h"
...
struct MainGUI
	...
	,pr::events::IRecv<Event_MediaSet>
	,pr::events::IRecv<Event_Message>
{
	pr::gui::RecentFiles  m_recent;
	WTL::CStatusBarCtrl   m_status;
	Imager*               m_img;
	pr::rdr::VideoCtrlDlg m_video_ctrl;
	...
	DECLARE_FRAME_WND_CLASS(_T("ImagerN GUI"), IDR_MAINFRAME);
