...
namespace pr
{
	namespace ph
	{
		namespace collision
		{
			CollisionFunction g_detection_functions[pr::TriTable<EShape_NumberOf>::SizeInc] =
			{
...
{
	return collision::g_detection_functions[GetTriTableIndexInc(objA.m_type, objB.m_type)];
}
