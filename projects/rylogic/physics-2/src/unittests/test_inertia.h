...
namespace pr::physics
{
	PRUnitTestClass(InertiaTests)
	{
		PRUnitTestMethod(InertiaConstruction)
		{
			...
			auto I1 = Transform(I0, m4x4::Transform(constants<float>::tau_by_4, constants<float>::tau_by_4, 0, v4{1,2,3,0}), ETranslateInertia::AwayFromCoM);
		...
		PRUnitTestMethod(InertiaInvConstruction)
		{
			...
			auto I1_inv = Transform(I0_inv, m4x4::Transform(constants<float>::tau_by_4, constants<float>::tau_by_4, 0, v4{1,2,3,0}), ETranslateInertia::AwayFromCoM);
		...
		PRUnitTestMethod(TranslateAndRotate)
		{
			...
			Ic1 = Rotate(Ic1, m3x4::Rotation(constants<float>::tau_by_4, 0, 0));
			Ic1 = Rotate(Ic1, m3x4::Rotation(0, constants<float>::tau_by_4, 0));
		...
		PRUnitTestMethod(Transform)
		{
			auto mass = 5.0f;
			constexpr auto moment = (1.0f/6.0f) * Sqr(2.0f);
			auto a2b = m4x4::Transform(constants<float>::tau_by_4, constants<float>::tau_by_4, 0, v4{0,0,1,1});
			auto Ic0 = Inertia{moment, mass};
