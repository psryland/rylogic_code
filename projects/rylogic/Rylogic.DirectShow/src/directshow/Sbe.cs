...
namespace Rylogic.DirectShow.SBE
{
    #region Declarations
    ...
    public sealed class SBEEvent
    {
        ...
        public static readonly Guid RecControlStarted = new(0x8966a89e, 0xf83e, 0x4c0e, 0xbc, 0x3b, 0xbf, 0xa7, 0x64, 0x9e, 0x4, 0xcb);

        /// <summary> EVENTID_SBE2RecControlStopped </summary>
        public static readonly Guid RecControlStopped = new(0x454b1ec8, 0xc9b, 0x4caa, 0xb1, 0xa1, 0x1e, 0x7a, 0x26, 0x66, 0xf6, 0xc3);

        /// <summary> SBE2_STREAM_DESC_EVENT </summary>
        public static readonly Guid StreamDescEvent = new(0x2313a4ed, 0xbf2d, 0x454f, 0xad, 0x8a, 0xd9, 0x5b, 0xa7, 0xf9, 0x1f, 0xee);

        /// <summary> SBE2_V1_STREAMS_CREATION_EVENT </summary>
        public static readonly Guid V1StreamsCreationEvent = new(0xfcf09, 0x97f5, 0x46ac, 0x97, 0x69, 0x7a, 0x83, 0xb3, 0x53, 0x84, 0xfb);

        /// <summary> SBE2_V2_STREAMS_CREATION_EVENT </summary>
        public static readonly Guid V2StreamsCreationEvent = new(0xa72530a3, 0x344, 0x4cab, 0xa2, 0xd0, 0xfe, 0x93, 0x7d, 0xbd, 0xca, 0xb3);
    }
    ...
    internal class SDMarshaler : ICustomMarshaler
    {
        ...
        public IntPtr MarshalManagedToNative(object managedObj)
        {
            ...
            m_sd = (SBE2_StreamDesc[])managedObj;
        ...
        public object MarshalNativeToManaged(IntPtr pNativeData)
        {
            ...
            if (m_sd == null) throw new NullReferenceException("m_sd");
            for (int x = 0; x < m_sd.Length; x++)
            {
                //m_sd[x] = new SBE2_StreamDesc(); Marshal.PtrToStructure(ip, m_sd[x]);
                m_sd[x] = (SBE2_StreamDesc?)Marshal.PtrToStructure(ip, typeof(SBE2_StreamDesc)) ?? throw new NullReferenceException("SBE2_StreamDesc");

                ip = new IntPtr(ip.ToInt64() + Marshal.SizeOf(typeof(SBE2_StreamDesc)));
            }
            return m_sd; // ? was return null...
        }
