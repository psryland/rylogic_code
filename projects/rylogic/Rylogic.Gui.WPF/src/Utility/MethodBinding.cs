...
namespace Rylogic.Gui.WPF
{
	public class MethodBindingExtension : MarkupExtension
	{
		...
		{
			if (serviceProvider.GetService(typeof(IProvideValueTarget)) is not IProvideValueTarget provide_value_target)
				throw new NullReferenceException("IProvideValueTarget service is not available");
