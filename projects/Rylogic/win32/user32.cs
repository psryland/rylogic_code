...
namespace Rylogic.Windows32
{
	...
	public static partial class Win32
	{
		...
		[DllImport("user32.dll", EntryPoint="SendMessage", SetLastError=true)]                                public static extern IntPtr SendMessage(HWND hwnd, uint msg, int wparam, int lparam); // Don't return int, it truncates on 64bit
