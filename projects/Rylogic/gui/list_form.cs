...
namespace pr.gui
{
	...
	public class ListForm :Form
	{
		...
		{
			using (var dlg = new ListForm{Title = title, PromptText = prompt, Items = items.Cast<object>(), SelectionMode = SelectionMode.One, DisplayMember = display_member})
		...
		{
			using (var dlg = new ListForm{Title = title, PromptText = prompt, Items = items.Cast<object>(), SelectionMode = SelectionMode.MultiExtended, DisplayMember = display_member})
				return dlg.ShowDialog(owner) == DialogResult.OK
		...
		private void InitializeComponent()
		{
			...
			this.m_btn_ok.Location = new System.Drawing.Point(29, 6);
			...
			this.m_btn_cancel.Location = new System.Drawing.Point(108, 6);
			...
			this.m_list.Size = new System.Drawing.Size(177, 178);
			...
			this.m_table.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this.m_table.Size = new System.Drawing.Size(189, 253);
			...
			this.m_panel_btns.Location = new System.Drawing.Point(0, 215);
			this.m_panel_btns.Margin = new System.Windows.Forms.Padding(0);
			this.m_panel_btns.Name = "m_panel_btns";
			this.m_panel_btns.Size = new System.Drawing.Size(189, 38);
