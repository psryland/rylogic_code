...
struct Context
{
	...
	Context()
		:m_cons()
	{
		m_cons.Open(Width,Height);
		m_cons.WindowPosition(EAnchor::MiddleCentre);
	}
...
//
// Structural materials are the materials you need to build the space craft from. The ideal material for building
...
//
// Computing technology controls the life support, navigation, and other systems of the space craft. Materials used in
...
//  weight is needed.
//
// Energy Shields are needed to protect the space craft and its occupants from the radiation and debris encountered
...
//   simulation determines the viability of the craft. If not viable, there is a chance to consume the materials used
//   in the test craft
