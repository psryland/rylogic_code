...
ldr::FileSources::FileSources(UserSettings& settings, pr::Renderer& rdr, pr::ldr::ObjectCont& store, LuaSource& lua_src)
:m_files()
,m_watcher()
,m_settings(settings)
,m_rdr(rdr)
...
// Add a file source
void ldr::FileSources::Add(char const* filepath)
{
...
void ldr::FileSources::Remove(char const* filepath)
{
...
void ldr::FileSources::RefreshChangedFiles()
{
...
void ldr::FileSources::FileWatch_OnFileChanged(char const*, void* user_data, bool&)
{
