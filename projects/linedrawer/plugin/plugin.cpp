...
void Plugin::OnEvent(ldr::Event_AddToViewport const& e)
{
...
void Plugin::Poll(double elapsed_s) const
{
	if (m_pi_step)
		m_pi_step(elapsed_s);
}
...
pr::ldr::LdrObject* Plugin::RegisterObject(char const* object_description, pr::ldr::ContextId ctx_id, bool async)
{
...
void Plugin::UnregisterObject(pr::ldr::LdrObject* object)
{
...
void Plugin::UnregisterAllObjects()
{
	m_store.resize(0);
}
