...
try:
	...
	projdir   = sys.argv[1] if len(sys.argv) > 1 else UserVars.root + "\\projects\\CoreCalc\\"
	targetdir = sys.argv[2] if len(sys.argv) > 2 else UserVars.root + "\\projects\\CoreCalc\\bin\\Debug\\"
