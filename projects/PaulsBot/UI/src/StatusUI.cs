...
namespace PaulsBot
{
	public class StatusUI :UserControl ,IDockable
	{
		#region UI Elements
		...
		public StatusUI(MainUI main)
		{
			InitializeComponent();
			DockControl = new DockControl(this, "Status") { TabText = "Status" };
			MainUI = main;
		}
		...
		{
			get { return m_main_ui; }
			set
			{
				if (m_main_ui == value) return;
				if (m_main_ui != null)
				{
					m_main_ui.TotalRisk -= HandleTotalRisk;
				}
				m_main_ui = value;
				if (m_main_ui != null)
				{
