...
//***********************************************
// Constant buffer definitions for deferred shading shader
// This file is included from C++ source as well
#ifndef PR_RDR_SHADER_DEFERRED_SHADING_CBUF_HLSL
#define PR_RDR_SHADER_DEFERRED_SHADING_CBUF_HLSL

// Per frame constants
#if SHADER_BUILD
cbuffer CBufFrame_DeferredShading :register(b0)
{
//	// Camera transform
...
#else
struct CBufFrame_DeferredShading
{
//	// Camera transform
...
// Per-model constants
#if SHADER_BUILD
cbuffer CBufModel_DeferredShading :register(b1)
{
//	// Object transform
...
#else
struct CBufModel_DeferredShading
{
//	// Object transform
//	pr::m4x4   m_o2s;
//	pr::m4x4   m_o2w;
