namespace RyLogViewer
{
	public partial class SettingsUI
	{
		...
		private void InitializeComponent()
		{
			...
			this.m_check_include_blank_lines = new System.Windows.Forms.CheckBox();
			...
			// m_group_line_ends
			// 
			this.m_group_line_ends.Controls.Add(this.m_check_include_blank_lines);
			...
			// 
			// m_check_include_blank_lines
			// 
			this.m_check_include_blank_lines.AutoSize = true;
			this.m_check_include_blank_lines.Location = new System.Drawing.Point(26, 87);
			this.m_check_include_blank_lines.Name = "m_check_include_blank_lines";
			this.m_check_include_blank_lines.Size = new System.Drawing.Size(114, 17);
			this.m_check_include_blank_lines.TabIndex = 5;
			this.m_check_include_blank_lines.Text = "Include blank lines";
			this.m_check_include_blank_lines.UseVisualStyleBackColor = true;
			// 
			// m_pattern_hl
			// 
		...
		private System.Windows.Forms.CheckBox m_check_include_blank_lines;
	}
}