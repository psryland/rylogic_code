...
namespace RyLogViewer
{
	...
	public class OutputFilepathUI :UserControl
	{
		...
		private ComboBox m_combo_filepaths;
		...
		public OutputFilepathUI()
		{
			...
			// Output file
			m_combo_filepaths.ToolTip(m_tt, "The file to save captured program output in.\r\nLeave blank to not save captured output");
			m_combo_filepaths.TextChanged += (s,a)=>
				{
					UpdateUI();
				};
		...
		/// <summary>Set the filepaths to show in the dropdown history</summary>
		public IEnumerable<string> OutputFilepathHistory
		{
			set
			{
				foreach (var i in value)
					m_combo_filepaths.Items.Add(i);
			}
		}
		...
		{
			get { return m_combo_filepaths.Text; }
			set { m_combo_filepaths.Text = value; UpdateUI(); }
		}
		...
		private void InitializeComponent()
		{
			...
			this.m_combo_filepaths = new ComboBox();
			this.SuspendLayout();
			//
			// m_lbl_output_file
			//
			...
			this.m_combo_filepaths.Size = new System.Drawing.Size(195, 21);
			this.m_combo_filepaths.TabIndex = 60;
			//
			// OutputFilepathUI
			//
			this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.Controls.Add(this.m_combo_filepaths);
