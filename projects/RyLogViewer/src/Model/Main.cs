	...
	public sealed partial class Main :Form ,IMainUI
	{
		...
		public Settings Settings
		{
			...
			set
			{
				...
				// Handlers
				void HandleSettingsSaved(object sender, SettingsSavingEventArgs e)
				{
					ApplySettings();
				}
		...
		/// <summary>Row filters</summary>
		public IEnumerable<IFilter> Filters => m_filters;
		...
		private void ShowTotD()
		{
			...
			using (var totd = new TipOfTheDayUI(this))
		...
		{
			new AboutUI(StartupOptions).ShowDialog(this);
		}
