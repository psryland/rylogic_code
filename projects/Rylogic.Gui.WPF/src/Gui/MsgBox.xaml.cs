...
namespace Rylogic.Gui.WPF
{
	...
	public partial class MsgBox : Window
	{
		...
		public MsgBox(Window owner, string message, string title, EButtons btns, EIcon icon, EButton default_button)
		{
			...
			// Choose a size for the window
			var sz = new Size(double.PositiveInfinity, double.PositiveInfinity);
			for (; ; )
			{
				m_panel.Measure(sz);
				var aspect = m_panel.DesiredSize.Width / m_panel.DesiredSize.Height;
				break;
			}
			Width = m_panel.DesiredSize.Width + SystemParameters.WindowNonClientFrameThickness.Left + SystemParameters.WindowNonClientFrameThickness.Right;
			Height = m_panel.DesiredSize.Height + SystemParameters.WindowNonClientFrameThickness.Top + SystemParameters.WindowNonClientFrameThickness.Bottom;
		}
		...
		public ImageSource Image
		{
			...
			set { m_img.Source = value; }
		}

		/// <summary>The message to display</summary>
		public string Message
		{
			get { return m_msg.Text; }
		...
		{
			get { return m_btn_positive.Content as string ?? string.Empty; }
			set { m_btn_positive.Content = value; }
		}

		/// <summary>Get/Set the text on the neutral button.</summary>
		public string NeutralBtnText
		{
			get { return m_btn_neutral.Content as string ?? string.Empty; }
			set { m_btn_neutral.Content = value; }
		}

		/// <summary>Get/Set the text on the negative button.</summary>
		public string NegativeBtnText
		{
			get { return m_btn_negative.Content as string ?? string.Empty; }
			set { m_btn_negative.Content = value; }
		}
	}
}
