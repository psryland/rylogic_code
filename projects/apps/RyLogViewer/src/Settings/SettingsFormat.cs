...
namespace RyLogViewer.Options
{
	public class Format :SettingsSet<Format>
	{
		...
		{
			get => get<string>(nameof(Formatter));
		...
		{
			get => get<int>(nameof(ColumnCount));
		...
		{
			get => get<string>(nameof(Encoding));
		...
		{
			get => get<string>(nameof(LineEnding));
		...
		{
			get => get<string>(nameof(ColDelimiter));
		...
		{
			get => get<bool>(nameof(AlternateLineColours));
		...
		{
			get => get<Color>(nameof(LineSelectBackColour));
		...
		{
			get => get<Color>(nameof(LineSelectForeColour));
		...
		{
			get => get<Color>(nameof(LineBackColour1));
		...
		{
			get => get<Color>(nameof(LineBackColour2));
		...
		{
			get => get<Color>(nameof(LineForeColour1));
		...
		{
			get => get<Color>(nameof(LineForeColour2));
