...
../../sdk/fluidsynth/_get.ps1

# Copy the folders in the 'lib' directory to the 'jniLibs' directory in the project
Copy-Item -Path "../../sdk/fluidsynth/fluidsynth/lib" -Destination "./app/src/main/jniLibs" -Recurse -Force

# Copy the headers in the 'include' directory to the 'cpp' directory in the project
Copy-Item -Path "../../sdk/fluidsynth/fluidsynth/include" -Destination "./app/src/main/cpp" -Recurse -Force

# Locate the Android NDK version >= 26
$ndk_version = "26.0.0"
$pre_build_version = "17.0.2"
