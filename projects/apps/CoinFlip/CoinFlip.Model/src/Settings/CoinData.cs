...
namespace CoinFlip.Settings
{
	...
	public class CoinData : SettingsSet<CoinData>
	{
		...
		public static void NotifyLivePriceChanged(Coin coin) => LivePriceChanged?.Invoke(null, new CoinEventArgs(coin));
		...
		public static void NotifyBalanceChanged(Coin coin) => BalanceChanged?.Invoke(null, new CoinEventArgs(coin));
