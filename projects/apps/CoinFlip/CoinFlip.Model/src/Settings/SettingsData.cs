...
namespace CoinFlip.Settings
{
	...
	public class SettingsData : SettingsBase<SettingsData>
	{
		...
		public SettingsData()
		{
			...
			LiveFunds = new FundData[1] { new FundData(Fund.Main.Id, new FundData.ExchData[0]) };
		...
		{
			get => get<string>(nameof(LastUser));
		...
		{
			get => get<string>(nameof(LastExchange));
		...
		{
			get => get<string>(nameof(LastChart));
		...
		{
			get => get<int>(nameof(MainLoopPeriodMS));
		...
		{
			get => get<int>(nameof(PriceDataUpdatePeriodMS));
		...
		{
			get => get<string>(nameof(ValuationCurrency));
		...
		{
			get => get<bool>(nameof(AutoAddCoins));
		...
		{
			get => get<FundData[]>(nameof(LiveFunds));
		...
		{
			get => get<BotData[]>(nameof(LiveBots));
		...
		{
			get => get<ChartSettings>(nameof(Chart));
		...
		{
			get => get<EquitySettings>(nameof(Equity));
		...
		{
			get => get<BackTestingSettings>(nameof(BackTesting));
		...
		{
			get => get<BinanceSettings>(nameof(Binance));
			set
			{
		...
		{
			get => get<PoloniexSettings>(nameof(Poloniex));
			set
			{
				if (value == null) throw new ArgumentNullException();
		...
		{
			get => get<BittrexSettings>(nameof(Bittrex));
			set
			{
				if (value == null) throw new ArgumentNullException();
		...
		{
			get => get<CrossExchangeSettings>(nameof(CrossExchange));
			set
			{
				if (value == null) throw new ArgumentNullException();
