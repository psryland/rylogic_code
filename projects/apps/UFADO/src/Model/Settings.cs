...
public class Settings :SettingsBase<Settings>
{
	...
	/// <summary>Location to store the work item data</summary>
	public string DBFilepath => Util.ResolveAppDataPath("Rylogic", Util.AppProductName, Path_.SanitiseFileName($"{Organization}-{Project}.json"));
