...
namespace Rylogic.VSExtensions_IntegrationTests
{
	...
	public class MenuItemTest
	{
		...
		public void LaunchCommand()
		{
			...
			{
				CommandID menuItemCmd = new CommandID(RylogicLimited.Rylogic_VSExtensions.GuidList.guidRylogic_VSExtensionsCmdSet, (int)RylogicLimited.Rylogic_VSExtensions.PkgCmdIDList.cmdidRylogicMenu);

				// Create the DialogBoxListener Thread.
				string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "Rylogic.VSExtensions", "RylogicLimited.Rylogic_VSExtensions.Rylogic_VSExtensionsPackage");
