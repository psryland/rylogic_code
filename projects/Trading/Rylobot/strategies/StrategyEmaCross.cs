...
namespace Rylobot
{
	...
	public class StrategyEmaCross :Strategy
	{
		...
		private const int EmaPeriods1 = 25;
		...
		/// <summary>The cross over EMA's. EMA0 = fast, EMA1 = slow</summary>
		...
		{
		//	PositionManagers.Add(new PositionManagerLetHerRun(this, position));
		}
