...
#ifndef RDR_EFFECT_XYZTextured_H
#define RDR_EFFECT_XYZTextured_H
...
namespace pr
{
	namespace rdr
	{
        namespace effect
		{
			class XYZTextured : public Base, public Common, public StdLighting, public StdTexturing
			{
			public:
...
#endif//RDR_EFFECT_XYZTextured_H
