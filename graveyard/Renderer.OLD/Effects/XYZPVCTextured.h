...
#ifndef RDR_EFFECT_XYZPVCTextured_H
#define RDR_EFFECT_XYZPVCTextured_H
...
namespace pr
{
	namespace rdr
	{
        namespace effect
		{
			class XYZPVCTextured : public Base, public Common, public StdLighting, public StdTexturing
			{
			public:
...
#endif//RDR_EFFECT_XYZPVCTextured_H
