...
#ifndef RDR_EFFECT_XYZLitPVCTextured_H
#define RDR_EFFECT_XYZLitPVCTextured_H
...
namespace pr
{
	namespace rdr
	{
        namespace effect
		{
			class XYZLitPVCTextured : public Base, public Common, public StdLighting, public StdTexturing
			{
			public:
...
#endif//RDR_EFFECT_XYZLitPVCTextured_H
