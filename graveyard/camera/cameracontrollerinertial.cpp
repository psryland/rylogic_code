...
DeviceSettings MakeFull3dKeyboardDeviceSettings(dinput::Context context, HWND window_handle)
{
...
//*****
CameraControllerFull3d::CameraControllerFull3d(const CameraControllerSettings& settings)
:m_settings(settings)
,m_context(m_settings.m_app_instance)
,m_keyboard(m_context, MakeFull3dKeyboardDeviceSettings(m_context, m_settings.m_window_handle))
{
...
//*****
// Camera Update
void CameraControllerFull3d::Step(float elapsed_seconds)
{
