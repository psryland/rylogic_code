...
// Constructor
MouseFreeCamera::MouseFreeCamera(const CameraControllerSettings& settings)
:m_settings(settings)
{
...
//*****
void MouseFreeCamera::Step(float /*elapsed_seconds*/)
{
	struct KeyState
	{
	...
	v2 delta_pos = v2::make(float(pos.x - m_last_pos.x), float(pos.y - m_last_pos.y));
	m_last_pos = pos;
