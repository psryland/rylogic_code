...
// Text Functions
	...
	int DrawTextA(LPCSTR lpstrText, int cchText, LPRECT lpRect, UINT uFormat)
	{
		ATLASSERT(m_hDC != NULL);
#ifndef _WIN32_WCE
		ATLASSERT((uFormat & DT_MODIFYSTRING) == 0);
#endif // !_WIN32_WCE
		return ::DrawTextA(m_hDC, lpstrText, cchText, lpRect, uFormat);
	}
	...
	int DrawTextA(LPSTR lpstrText, int cchText, LPRECT lpRect, UINT uFormat)
	{
		ATLASSERT(m_hDC != NULL);
		return ::DrawTextA(m_hDC, lpstrText, cchText, lpRect, uFormat);
	}
	int DrawTextW(LPWSTR lpstrText, int cchText, LPRECT lpRect, UINT uFormat)
	{
		ATLASSERT(m_hDC != NULL);
		return ::DrawTextW(m_hDC, lpstrText, cchText, lpRect, uFormat);
	}
