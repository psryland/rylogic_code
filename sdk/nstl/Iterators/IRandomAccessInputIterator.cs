...
namespace NStl.Iterators
{
    ...
    public interface IRandomAccessInputIterator<T> : IBidirectionalInputIterator<T>
    {
        /// <summary>
        ...
        IRandomAccessInputIterator<T> Add(int count);
        ...
        int Diff(IRandomAccessInputIterator<T> rhs);
        ...
        /// <param name="rhs"></param>
        /// <returns></returns>
        bool Less(IRandomAccessInputIterator<T> rhs);
    }
}