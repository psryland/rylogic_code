...
namespace NStl.Arithmetic
{
    ...
    {
        /// <summary>
        /// Creates a functor that lets you add two <see cref="decimal"/> types.
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Creates a functor that lets you add two <see cref="int"/> types.
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Creates a functor that lets you add two <see cref="long"/> types.
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Creates a functor that lets you add two <see cref="short"/> types.
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Creates a functor that lets you add two <see cref="float"/> types.
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Creates a functor that lets you add two <see cref="double"/> types.
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Creates a functor that lets you add two <see cref="string"/> types.
        /// </summary>
        /// <returns></returns>
        public static IBinaryFunction<string, string, string> String()
        {
            return Functional.PtrFun<string, string, string>(
                delegate(string lhs, string rhs) { return lhs + rhs; }
                );
        }
    }
}
