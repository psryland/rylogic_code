...
namespace NStl
{
    public static partial class Algorithm
    {
        ...
        /// </remarks>
        public static T
            Accumulate<T>(IInputIterator<T> first, IInputIterator<T> last, T init,
                          IBinaryFunction<T, T, T> binaryFunction)
        {
            return Accumulate(first.AsEnumerable(last), init, binaryFunction);
        }
        /// <summary>
        /// <para>
        /// Accumulate is a generalization of summation: 
                         ...
                         IBinaryFunction<T, T, T> binaryFunction)
        {
            foreach(T t in range)
                init = binaryFunction.Execute(init, t);
            return init;
        }
    }
}
