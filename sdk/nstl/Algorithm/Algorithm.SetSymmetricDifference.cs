...
namespace NStl
{
    public static partial class Algorithm
	{
        ...
        /// </returns>
        public static OutIt
            SetSymmetricDifference<T, OutIt>(IInputIterator<T> first1, IInputIterator<T> last1,
            ...
            where OutIt : IOutputIterator<T>
        {
            ...
            for (; !Equals(first1, last1) && !Equals(first2, last2); )
            {
                ...
                {
                    (dest.PostIncrement()).Value = first2.Value;
                    first2.PreIncrement();
                }
                else
                {
        ...
        public static OutIt
            ...
            where OutIt : IOutputIterator<T>
        {
            return SetSymmetricDifference(first1, last1, first2, last2, dest, Compare.Less<T>());
        }
	}
}
