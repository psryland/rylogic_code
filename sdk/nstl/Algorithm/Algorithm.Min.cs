...
namespace NStl
{
    public static partial class Algorithm
    {
        ...
        /// </returns>
        public static T
            Min<T>(T lhs, T rhs, IBinaryFunction<T, T, bool> less)
        {
            return less.Execute(lhs, rhs) ? lhs : rhs;
        }
        /// <summary>
        /// <para>
        /// Min returns the greater of its two arguments; it returns 
        ...
        /// </returns>
        public static T
            Min<T>(T lhs, T rhs) where T : IComparable<T>
        {
            return Min(lhs, rhs, Compare.Less<T>());
        }
    }
}
