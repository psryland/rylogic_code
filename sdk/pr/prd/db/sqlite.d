...
class SqliteDatabase
{
	...
	void close()
	{
		// Note: Applications must finalize all prepared statements and
		// close all BLOB handles associated with the sqlite3 object prior to attempting
		// to close it. If sqlite3_close() is called on a database connection that still
		// has outstanding prepared statements or BLOB handles, then it returns SQLITE_BUSY (result=5).
