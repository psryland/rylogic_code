...
namespace pr.common
{
	public struct Range
	{
		...
		public Range(int begin, int end)  { m_begin = begin; m_end = end; }
		...
		public int  Count                 { get { return m_end -  m_begin; } set { m_end = m_begin + value; } }
		...
		public int  First                 { get { return m_begin; } set { int count = Count; m_begin = value; m_end = value + count; } }
		...
		public int  Last                  { get { return m_end; } set { int count = Count; m_begin = value - count; m_end = value; } }
		...
		public int  Mid                   { get { return (m_begin + m_end) / 2; } set { int count = Count; m_begin = value - count/2; m_end = value + (count+1)/2; } }
		...
		public IEnumerable<int> Enumerate { get { for (int i = m_begin; i != m_end; ++i) yield return i; } }
