...
//  - Initial release
// http://www.codeproject.com/KB/wtl/wtlgrid2.aspx

#pragma once
#ifndef PR_GUI_GRID_CTRL_H
#define PR_GUI_GRID_CTRL_H
...
namespace pr
{
	namespace gui
	{
		...
		public:
			...
			{
			public:
				virtual bool OnRowChanging(UINT /*uID*/,long /*nRow*/) { return true; } // Return false to abort row change
				virtual void OnRowChanged(UINT /*uID*/,long /*nRow*/) {}
				virtual void OnEdit(UINT /*uID*/,long /*nRow*/) {}
				virtual bool OnDeleteRow(UINT /*uID*/,long /*nRow*/) { return true; } // Return false to abort delete
				...
				virtual COLORREF GetCellColor(UINT /*uID*/,long /*nRow*/,LPCTSTR /*pszColumn*/) { return (COLORREF)-1; } // Return (COLORREF)-1 for default colors
				virtual bool OnValidate(UINT /*uID*/) { return true; } // Return false if not valid
			};
		...
		protected:
			...
			public:
				...
				{
					CColumn& col = GetColumn(0); (void)col;
			...
			public:
				...
				void DoPaint(CDCHandle dc2,LPRECT lpRect=NULL)
				{
					...
					for (long i=0; i<nRows; i++)
					{
						...
						{
							CColumn& column = *m_columns[col]; (void)column;
				...
				void DoDrag(long mx,bool bDoDrag)
				{
					...
					int old = dc.SetROP2(R2_NOT); (void)old;
					if (bDoDrag)
					{
						dc.MoveTo(m_old_x,0);
