...
pr::ISize pr::rdr::Pitch(ISize size, DXGI_FORMAT fmt)
{
	ISize pitch;
...
size_t pr::rdr::MipCount(pr::ISize size)
{
...
pr::ISize pr::rdr::MipDimensions(pr::ISize size, size_t levels)
{
...
size_t pr::rdr::MipChainSize(pr::ISize size, size_t levels)
{
