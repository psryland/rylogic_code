...
void pr::ldr::MeasureDlg::UpdateMeasurementInfo(bool raise_event)
{
	...
	if (m_point0 != m_point1)
	{
		...
		std::string str;
		pr::ldr::GroupStart("Measurement", str);
		pr::ldr::Line("dist" , 0xFFFFFFFF, m_point0, m_point1, str);
		pr::ldr::Line("distX", 0xFFFF0000, m_point0, p0, str);
		pr::ldr::Line("distY", 0xFF00FF00, p0, p1, str);
...
void pr::ldr::AngleDlg::UpdateAngleInfo(bool raise_event)
{
	...
	{
		std::string str;
		pr::ldr::GroupStart("AngleDlg", str);
		pr::ldr::Line("edge0", 0xFFFFFFFF, m_origin, m_point0, str);
		pr::ldr::Line("edge1", 0xFFFFFF00, m_origin, m_point1, str);
