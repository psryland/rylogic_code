...
namespace pr
{
	...
	float DistanceSq_PointToBoundingBox(v4 const& point, BoundingBox const& bbox);
	...
	v4    ClosestPoint_PointToBoundingBox(v4 const& point, BoundingBox const& bbox);
	...
	bool  Intersect_LineSegmentToBoundingBox(v4 const& lineS, v4 const& lineE, BoundingBox const& bbox);
	...
	bool  Clip_LineSegmentToBoundingBox(v4 const& point, v4 const& line, BoundingBox const& bbox, float& t0, float& t1);
	bool  Clip(Plane const& plane, Line3& line);
	bool  Clip(BoundingBox const& bbox, Line3& line);
