...
namespace WeifenLuo.WinFormsUI.Docking
{
    ...
    {
		public DockContent() :this(null) {}
        public DockContent(string persistentString)
        {
			m_persistentString = persistentString ?? GetType().ToString();
        ...
        {
            return m_persistentString;
        }
		private string m_persistentString;
