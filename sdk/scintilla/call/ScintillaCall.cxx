...
void ScintillaCall::AppendStyledText(Position length, const char *c) {
	CallString(Message::AppendStyledText, length, c);
}

void ScintillaCall::InsertStyledText(Position pos, const char *c) {
	CallString(Message::InsertStyledText, pos, c);
}
