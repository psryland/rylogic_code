...
protected:	// ScintillaBase subclass needs access to much of Editor
	...
	Sci::Position InsertText(const char* buffer, Sci::Position position, Sci::Position length, bool styled);
	//void AddStyledText(const char *buffer, Sci::Position appendLength); // Replaced by 'InsertText'
