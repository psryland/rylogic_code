...
def UpdateVersionNumbers(sci, root):
    UpdateLineInFile(root + "src/win32/ScintRes.rc", "#define VERSION_SCINTILLA",
        "#define VERSION_SCINTILLA \"" + sci.versionDotted + "\"")
    UpdateLineInFile(root + "src/win32/ScintRes.rc", "#define VERSION_WORDS",
...
def RegenerateAll(root):
    ...
    Regenerate(root + "src/win32/scintilla.mak", "#", sci.lexFiles)
