...
def RegenerateAll(root, showMaxID):
	f = Face.Face()
	f.ReadFromFile(root + "include/scintilla/Scintilla.iface")
	Regenerate(root + "include/scintilla/Scintilla.h", "/* ", printHFile(f))
	Regenerate(root + "include/scintilla/SciLexer.h", "/* ", printLexHFile(f))
	if showMaxID:
