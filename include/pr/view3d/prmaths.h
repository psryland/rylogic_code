...
namespace view3d
{
	...
	template <> struct Convert<pr::v2  , View3DV2  > { static pr::v2   To(View3DV2   const& v)  { return pr::v2(v.x, v.y);           } };
	template <> struct Convert<pr::v4  , View3DV4  > { static pr::v4   To(View3DV4   const& v)  { return pr::v4(v.x, v.y, v.z, v.w); } };
	template <> struct Convert<pr::m4x4, View3DM4x4> { static pr::m4x4 To(View3DM4x4 const& m)  { return pr::m4x4(view3d::To<pr::v4>(m.x), view3d::To<pr::v4>(m.y), view3d::To<pr::v4>(m.z), view3d::To<pr::v4>(m.w)); } };
	template <> struct Convert<pr::BBox, View3DBBox> { static pr::BBox To(View3DBBox const& bb) { return pr::BBox(view3d::To<pr::v4>(bb.centre), view3d::To<pr::v4>(bb.radius)); } };
}
