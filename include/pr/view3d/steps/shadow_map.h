...
namespace pr::rdr
{
	...
	{
		// Notes:
		//  - this is probably broken due to refactoring of the Frustum type.
	...
	private:
		...
		bool CreateProjection(pr::Frustum const& shadow_frustum, Frustum::EPlane face, Light const& light, pr::m4x4 const& c2w, float max_range, pr::m4x4& w2s);
