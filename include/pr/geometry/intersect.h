...
namespace pr
{
	...
	// Return the feature of the box in a given direction.
	// 'points' should be an array of 4 pr::v4s.
	...
	namespace impl
	{
		...
		bool Intersect_OBoxToOBox(OrientedBox const& lhs, OrientedBox const& rhs, Penetration& pen)
		{
	...
	inline bool Intersect_OBoxToOBox(OrientedBox const& lhs, OrientedBox const& rhs)
	{
		impl::IgnorePenetration p;
		return impl::Intersect_OBoxToOBox<void, impl::IgnorePenetration>(lhs, rhs, p);
	}
	...
	inline bool Intersect_OBoxToOBox(OrientedBox const& lhs, OrientedBox const& rhs, v4& axis, float& penetration)
	{
		impl::MinPenetration p;
		if (!impl::Intersect_OBoxToOBox<void, impl::MinPenetration>(lhs, rhs, p)) return false;
	...
	inline bool Intersect_OBoxToOBox(OrientedBox const& lhs, OrientedBox const& rhs, v4& axis, float& penetration, v4& pointA, v4& pointB)
	{
		if (!Intersect_OBoxToOBox(lhs, rhs, axis, penetration))
			return false;
...
/* Clip and intersect are the same thing
