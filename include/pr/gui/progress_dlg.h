	...
	namespace gui
	{
		...
		public:
			...
			ProgressDlg(wchar_t const* title, wchar_t const* desc, Func&& func, Args&&... args)
				...
				,m_exception()
				,m_shown()
				,m_lbl_desc(IDC_TEXT_DESC, this, EAnchor::TopLeft, "desc")
				,m_bar(IDC_PROGRESS_BAR, this, EAnchor::Left|EAnchor::Top|EAnchor::Right, "bar")
				,m_btn(IDCANCEL, this, EAnchor::Bottom, "cancel")
				,m_mutex()
				,m_cv()
				,m_worker()
			//	,OnEvent(handler)
