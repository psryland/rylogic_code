...
namespace pr::gui
{
	...
	{
		// The step function for a context. First parameter is the elapsed time in seconds.
		// For fixed step rate contexts, this is always the 'ticks_per_frame' value. For
		// non-fixed step rates, this is the elapsed real time.
