...
namespace pr::app
{
	...
	private:
		...
		void InitModel(Renderer& rdr)
		{
			...
			Vert const verts[] =
			{
				{{-0.1f,  0.0f,  0.0f, 1.0f}, {1.0f, 0.0f, 0.0f, 1.0f}, v4::Zero(), v2::Zero()},
				{{ 1.0f,  0.0f,  0.0f, 1.0f}, {1.0f, 0.0f, 0.0f, 1.0f}, v4::Zero(), v2::Zero()},
				{{ 0.0f, -0.1f,  0.0f, 1.0f}, {0.0f, 1.0f, 0.0f, 1.0f}, v4::Zero(), v2::Zero()},
				{{ 0.0f,  1.0f,  0.0f, 1.0f}, {0.0f, 1.0f, 0.0f, 1.0f}, v4::Zero(), v2::Zero()},
				{{ 0.0f,  0.0f, -0.1f, 1.0f}, {0.0f, 0.0f, 1.0f, 1.0f}, v4::Zero(), v2::Zero()},
				{{ 0.0f,  0.0f,  1.0f, 1.0f}, {0.0f, 0.0f, 1.0f, 1.0f}, v4::Zero(), v2::Zero()},
			};
