...
namespace pr
{
	namespace ldr
	{
		...
		inline m4x4& ParseLdrTransform(script::Reader& reader, m4x4& o2w)
		{
			...
			for (EKeyword kw; reader.NextKeywordH(kw);)
			{
				...
				default:
					{
						reader.ReportError(script::EResult::UnknownToken);
						break;
					}
				case EKeyword::M4x4:
					{
						...
						if (o2w_.w.w != 1)
						{
							reader.ReportError(script::EResult::UnknownValue, "M4x4 must be an affine transform with: w.w == 1");
							break;
						}
						p2w = o2w_ * p2w;
						break;
				...
				case EKeyword::Align:
					{
						...
						if (IsZero3(axis))
						{
							reader.ReportError(script::EResult::UnknownValue, "axis_id must one of ±1, ±2, ±3");
							break;
						}
		...
		inline m4x4 ParseLdrTransform(script::Reader& reader)
		{
