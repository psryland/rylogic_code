...
namespace pr::ldr
{
	...
	std::string CreateDemoScene()
	{
		...
		str.append(""
			...
			"		var c = \n"
			"			t < 0.2f ? Colour32.Lerp(Colour32.White, Colour32.Yellow, Math_.Frac(0.0, t, 0.2)) :\n"
			"			t < 0.5f ? Colour32.Lerp(Colour32.Yellow, Colour32.Red, Math_.Frac(0.2, t, 0.5)) :\n"
			"			t < 1.0f ? Colour32.Lerp(Colour32.Red, 0x00FF0000, Math_.Frac(0.5, t, 1.0)) :\n"
