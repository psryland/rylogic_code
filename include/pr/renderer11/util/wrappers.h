...
namespace pr
{
	namespace rdr
	{
		...
		struct SamplerDesc :D3D11_SAMPLER_DESC
		{
			...
			static SamplerDesc AnisotropicClamp() { return SamplerDesc(D3D11_TEXTURE_ADDRESS_CLAMP, D3D11_TEXTURE_ADDRESS_CLAMP, D3D11_TEXTURE_ADDRESS_CLAMP , D3D11_FILTER_ANISOTROPIC); }
