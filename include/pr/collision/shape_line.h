...
namespace pr::collision
{
	...
	template <typename>
	v4 pr_vectorcall SupportVertex(ShapeLine const& shape, v4 direction, int, int& sup_vert_id)
	{
	...
	template <typename>
	void pr_vectorcall ClosestPoint(ShapeLine const& shape, v4 point, float& distance, v4& closest)
	{
